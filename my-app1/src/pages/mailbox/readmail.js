    ...
    <>
      ...
      <div className="row">
        <div className="col-md-3">
          <a href="/mailbox/compose" className="btn btn-primary btn-block margin-bottom">Compose</a>
          ...
          <div className="box box-primary">
            ...
            <div className="box-footer">
              <div className="pull-right">
                <button type="button" className="btn btn-default"><i className="fa fa-reply"></i> Reply</button>
                <button type="button" className="btn btn-default"><i className="fa fa-share"></i> Forward</button>
              </div>
              <button type="button" className="btn btn-default"><i className="fa fa-trash-o"></i> Delete</button>
              <button type="button" className="btn btn-default"><i className="fa fa-print"></i> Print</button>
            </div>
