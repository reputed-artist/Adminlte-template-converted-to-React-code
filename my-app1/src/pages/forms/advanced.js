          ...
          <div className="row">
            <div className="col-md-6">
              <div className="form-group">
                <label>Minimal</label>
                <select className="form-control select2" defaultValue="Alaska" style={{width: "100%"}}>
              ...
              <div className="form-group">
                ...
                <select className="form-control select2" defaultValue="Alaska" disabled="disabled" style={{width: "100%"}}>
                 <option value="Alaska">Alaska</option>
                  <option value="California">California</option>
                  <option value="Delaware">Delaware</option>
                  <option value="Tennessee">Tennessee</option>
            ...
            <div className="col-md-6">
              <div className="form-group">
                ...
                <select className="form-control select2" multiple="multiple" data-placeholder="Select a State"
                        style={{width: "100%"}} defaultValue="Alaska">
                  <option value="Alaska">Alaska</option>
                  <option value="California">California</option>
                  <option value="Delaware">Delaware</option>
                  <option value="Tennessee">Tennessee</option>
              ...
              <div className="form-group">
                ...
                <select className="form-control select2" style={{width: "100%"}} defaultValue="Alaska">
                 <option value="Alaska">Alaska</option>
                  <option value="California">California</option>
                  <option value="Delaware">Delaware</option>
                  <option value="Tennessee">Tennessee</option>
